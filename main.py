...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=64, help='Batch size for training and inference')
    parser.add_argument('--learning_rate', type=float, default=0.001, help='Learning rate for training')
    parser.add_argument('--image_path', type=str, default='data/Test/00000.png', help='Path to the image for inference')
    parser.add_argument('--process_all', action='store_true', help='Process all PNG files in data/Test/ directory during inference')
